...
export default function CampaignsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-3 py-4 sm:p-6 space-y-6">
      ...
      <div id="campaigns-form" className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 sm:p-6 space-y-4">
      ...
      {/* Historique */}
      <div id="campaigns-history" className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 sm:p-6">
